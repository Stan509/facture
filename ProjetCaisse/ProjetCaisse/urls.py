...
urlpatterns = [
    ...
    path('dette/', views.liste_dette, name='liste_dette'),
    ...
    path('retraits/', views.page_retraits, name='page_retraits'),
    path('comptabilite/', views.votre_vue_de_comptabilite, name='comptabilite'),
